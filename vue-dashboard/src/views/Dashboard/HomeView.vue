<template>
  <div class="space-y-6">
        ...
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-sm text-green-600">
              +{{ stats.documents?.generated || 0 }} generados
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-bold text-gray-900">
              {{ stats.conversations?.total_messages || 0 }}
            </p>
            <p class="text-sm text-blue-600">
              {{ stats.conversations?.messages_in_period || 0 }} en período
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-bold text-gray-900">
              {{ stats.conversations?.active_conversations || 0 }}
            </p>
            <p class="text-sm text-gray-500">
              {{ stats.chatbot?.bot_mode_chats || 0 }} en modo bot
            </p>
          </div>
        </div>
      </div>
    ...
    <div v-if="stats" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div v-if="stats.documents?.by_type" class="space-y-3">
          <div
            v-for="[type, count] in Object.entries(stats.documents.by_type)"
            :key="type"
            ...
            <div class="flex items-center">
              <div class="w-24 bg-gray-200 rounded-full h-2 mr-3">
                <div
                  ...
                  :style="{ width: getPercentage(count, stats.documents.total) + '%' }"
                ></div>
              </div>
    ...
    <div
      v-if="stats?.documents?.recent_documents?.length"
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr
              v-for="doc in stats.documents.recent_documents.slice(0, 5)"
              :key="doc._id"
            >
    ...
    <div v-else class="text-center py-12">
      ...
      <p class="mt-1 text-sm text-gray-500">
        Las estadísticas se mostrarán aquí una vez que haya actividad en el sistema.
      </p>
    </div>
  </div>
</template>
...
const { bots, fetchBots } = useBots() // 🔥 NUEVO
...
const loadStats = async () => {
  try {
    ...
    if (selectedBot.value) {
      params.bot_id = selectedBot.value
    }
